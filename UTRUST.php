...
class UTRUST extends PaymentModule
{
    ...
    {
        Configuration::deleteByName('UTRUST_CLIENT_ID');
        Configuration::deleteByName('UTRUST_SECRET_ID');
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'desc' => $this->l('Enter your Utrust Client ID'),
                        'name' => 'UTRUST_CLIENT_ID',
                        'required' => true,
                    ...
                    array(
                        ...
                        'desc' => $this->l('Enter your Utrust Secret ID code'),
                        'name' => 'UTRUST_SECRET_ID',
                        'required' => true,
    ...
    protected function getConfigFormValues()
    {
        return array(
            ...
            'UTRUST_CLIENT_ID' => Configuration::get('UTRUST_CLIENT_ID'),
            'UTRUST_SECRET_ID' => Configuration::get('UTRUST_SECRET_ID')
        );
    }

    protected function postValidation()
    {
            if (!Tools::getValue('UTRUST_CLIENT_ID'))
                $this->_postErrors[] = $this->l('Please, enter your Utrust Client ID.');
            elseif (!Tools::getValue('UTRUST_SECRET_ID'))
                $this->_postErrors[] = $this->l('Please, enter your Utrust secret ID code.');
